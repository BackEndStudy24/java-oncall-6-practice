...
- ✅ 근무 인원이 5명 미만일 경우 예외 처리
  - 입력 : `성훈,동균,효성,포비`
  - 출력 : `[ERROR] 최소 근무 인원은 5명입니다. 다시 입력 해주세요.`
- ✅ 근무 인원이 35명 초과일 경우 예외 처리
  - 입력 : `성훈1,성훈2,성훈3....성훈34,성훈35,성훈36`
  - 출력 : `[ERROR] 최대 근무 인원은 35명입니다. 다시 입력 해주세요.`
- ✅ 휴일, 평일 근무에 모두 안들어갈 경우 예외 처리
  - 입력 : `성훈, 효성, 동균, 포비, 포비짱, 수아 / 성훈, 효성, 동균, 포비, 포비짱 `
  - 출력 : `[ERROR] 근무자는 평일, 휴일에 모두 한 번씩 들어가야 합니다. 다시 입력 해주세요.`
