...
## 📚 기능 명세
- ☑️ 기본적으로 순번에 따라 비상 근무일을 배정한다.
- ☑️ 평일과 휴일(토요일, 일요일, 법정공휴일) 비상 근무 순번을 다르게 운영하고 있다.
...
### 📕 입력 Exceptions
- ☑️ 비상근무 배정 월이 올바른 형식이 아닐 경우
  - 입력 : `오월 | -5`
  - 출력 : `[ERROR] 올바른 월 형식이 아닙니다. 다시 입력 해주세요.`
- ☑️ 비상근무 배정 요일이 올바른 형식이 아닐 경우
  - 입력 : `화수`
  - 출력 : `[ERROR] 올바른 요일 형식이 아닙니다. 다시 입력 해주세요.`
- ☑️ 공백을 입력받을 경우 예외 처리
  - 입력 : ` `
  - 출력 : `[ERROR] 공백은 입력할 수 없습니다. 다시 입력 해주세요.`
- ☑️ 중복된 이름이 존재할 경우 예외 처리
  - 입력 : `성훈,동균,효성,포비,포비짱,성훈`
  - 출력 : `[ERROR] 중복된 이름이 존재합니다. 다시 입력 해주세요.`
- ☑️ 이름이 5자 초과일 경우 예외 처리
  - 입력 : `김성훈,김동균,김효성,포비,포비짱,김성훈입니다`
  - 출력 : `[ERROR] 이름은 최대 5자까지 입력 가능합니다. 다시 입력 해주세요.`
- ☑️ 근무 인원이 5명 미만일 경우 예외 처리
  - 입력 : `성훈,동균,효성,포비`
  - 출력 : `[ERROR] 최소 근무 인원은 5명입니다. 다시 입력 해주세요.`
- ☑️ 근무 인원이 35명 초과일 경우 예외 처리
  - 입력 : `성훈1,성훈2,성훈3....성훈34,성훈35,성훈36`
  - 출력 : `[ERROR] 최대 근무 인원은 35명입니다. 다시 입력 해주세요.`
